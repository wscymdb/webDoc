...
现在有一个水龙头 🚰，我们来接水，假设我们限制每秒只能接一滴水，这时候水龙头每秒就滴一滴水，也符合我们的限制，但是这时候水龙头每秒滴 5 滴水了，那么明显不符合我们的需求了，每秒多余的 4 滴水我们只能抛弃了

现在我们换一种方法 我们在水龙头下面放一个漏斗(桶、盆都行) 这个漏斗每秒固定的只能流出一滴水 他的容量是 5 滴 所以这时候水龙头滴 5 滴水都会放入这个漏斗里 然后存入的水会每秒流出一滴 所以符合我们的要求

现在有一个问题 既然这个漏斗容量是 5 那么水龙头每秒流出 5 滴 所以水龙头 2 秒流出的水滴怎么分配的

- 第一秒的时候流出了 5 滴水 因为我们的设定了每秒会接受 1 滴水 所以还有 4 滴水会放到漏斗中进行缓存 因为漏斗的容量是 5 所以此时漏斗还可以放入 1 滴水
- 第二秒的时候 漏斗的水流出了 1 滴 此刻漏斗的容量还有 2 滴 与此同时 水龙头又流出了 5 滴水 此刻不会立即接受 1 滴水 因为上一秒的水还没有接受完毕呢 所以 5 滴水会流进漏斗 但是此刻漏斗只有 2 滴的容量了 所以水会剩下 3 滴会被抛弃
- 所以 2 秒内一共可以接受 7 滴水
